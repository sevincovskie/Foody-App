  ...
  return (
    <div className=" min-h-screen bg-darkBlue_1">
      <Head>
        ...
        <link rel="icon" href="/style/images/png/admin.png" />
      </Head>
      <div>
          ...
          <div className=" flex  justify-center pb-7 ">
            <div className=" flex flex-col-reverse   sm:flex-col-reverse  md:flex-row  ">
              <div className=" w-full sm:w-full md:w-1/2  md:bg-darkBlue_2 py-14  px-6 sm:px-7 md:px-12 ">
                <p className=" text-grayText font-bold text-4xl text-center  mb-10">Welcome Admin</p>
                ...
                <button className=" text-white font-medium text-2xl  w-full bg-lightPurple_3 py-3 rounded"> Sign In</button>
              </div>
